...
<![endif]-->
<?php bedstone_google_fonts(); // e.g. 'Roboto:400,400italic,700,700italic|Open+Sans|Roboto+Condensed:300' ?>
<?php wp_head(); ?>
...
<header class="site-header container" role="banner">
    ...
    <div class="row">
        ...
        <div class="logo col-sm-6">
            <a class="hidden-print" href="/"><img src="http://placehold.it/350x150" alt="<?php bloginfo('name'); ?>"></a>
            <h1 class="visible-print-block"><?php bloginfo('name'); ?></h1>
        </div>

        <div class="nav-secondary col-sm-6 pull-right hidden-print">
            <ul>
